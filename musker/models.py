...
class Profile(models.Model):
    ...
    profile_bio = models.CharField(blank=True, null=True, max_length=500)
    homepage_link = models.CharField(blank=True, null=True, max_length=100)
    ...
    linkedln_link = models.CharField(blank=True, null=True, max_length=100)
